...
$GLOBALS['TL_LANG']['tl_nc_language']['copy']['1']                 = 'Copier la langue ID %s.';
$GLOBALS['TL_LANG']['tl_nc_language']['delete']['0']               = 'Supprimer la langue';
$GLOBALS['TL_LANG']['tl_nc_language']['delete']['1']               = 'Supprimer la langue ID %s.';
$GLOBALS['TL_LANG']['tl_nc_language']['edit']['0']                 = 'Éditer la langue';
$GLOBALS['TL_LANG']['tl_nc_language']['edit']['1']                 = 'Éditer la langue ID %s.';
$GLOBALS['TL_LANG']['tl_nc_language']['email_html']['0']           = 'HTML';
$GLOBALS['TL_LANG']['tl_nc_language']['email_html']['1']           = 'Saisir le code HTML.';
$GLOBALS['TL_LANG']['tl_nc_language']['email_external_images']['0']= 'Images externes';
$GLOBALS['TL_LANG']['tl_nc_language']['email_external_images']['1']= 'Ne pas inclure des images dans les messages HTML.';
...
$GLOBALS['TL_LANG']['tl_nc_language']['email_sender_name']['1']    = 'Saisir le nom de l\'expéditeur.';
$GLOBALS['TL_LANG']['tl_nc_language']['email_subject']['0']        = 'Sujet';
$GLOBALS['TL_LANG']['tl_nc_language']['email_subject']['1']        = 'Saisir un sujet pour cet email.';
$GLOBALS['TL_LANG']['tl_nc_language']['email_text']['0']           = 'Texte brut';
...
$GLOBALS['TL_LANG']['tl_nc_language']['meta_legend']               = 'Informations méta';
