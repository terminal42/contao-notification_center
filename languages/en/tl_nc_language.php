...
$GLOBALS['TL_LANG']['tl_nc_language']['attachment_templates']       = array('Attachments from templates', 'These files are used as templates for an attachment. Simple tokens inside these files are replaced and attached to the message.');
