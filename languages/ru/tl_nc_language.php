...
$GLOBALS['TL_LANG']['tl_nc_language']['attachment_tokens']['1']    = 'Введите <strong>разделенный запятыми</strong> список маркеров в этой области. Используйте авто-завершение, чтобы увидеть доступные маркеры.';
...
$GLOBALS['TL_LANG']['tl_nc_language']['email_external_images']['1']= 'Не вставлять изображения в HTML письма.';
...
$GLOBALS['TL_LANG']['tl_nc_language']['recipients']['1']           = 'Введите <strong>разделенный запятыми</strong> список получателей. Используйте авто-завершение, чтобы увидеть доступные маркеры.';
