 ...
 *
 * last-updated: 2014-05-28T09:43:39+02:00
 */


$GLOBALS['TL_LANG']['tl_nc_language']['attachment_tokens']['0']    = 'Вложения через маркеры';
$GLOBALS['TL_LANG']['tl_nc_language']['attachment_tokens']['1']    = 'Введите <strong>разделенный запятыми</strong> список маркеров в этой области. Используйте мастер справки, чтобы увидеть доступные маркеры.';
...
$GLOBALS['TL_LANG']['tl_nc_language']['fallback']['0']             = 'Запасной вариант';
$GLOBALS['TL_LANG']['tl_nc_language']['fallback']['1']             = 'Выберите чекбокс, если этот язык должен быть запасным вариантом.';
...
$GLOBALS['TL_LANG']['tl_nc_language']['recipients']['1']           = 'Введите <strong>разделенный запятыми</strong> список получателей. Используйте мастер справки, чтобы увидеть доступные маркеры.';
