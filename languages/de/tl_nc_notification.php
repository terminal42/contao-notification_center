...
$GLOBALS['TL_LANG']['tl_nc_notification']['type']['1']                        = 'Bitte wählen Sie einen Benachrichtigungstyp aus.';
$GLOBALS['TL_LANG']['tl_nc_notification']['type']['contao']                   = 'Contao';
$GLOBALS['TL_LANG']['tl_nc_notification']['type']['core_form']['0']           = 'Formularübertragung';
