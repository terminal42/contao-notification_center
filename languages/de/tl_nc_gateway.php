...
$GLOBALS['TL_LANG']['tl_nc_gateway']['cronjob_legend']                 = 'Cronjob-Einstellungen';
...
$GLOBALS['TL_LANG']['tl_nc_gateway']['ftp_error_connect']              = 'Verbindung zum FTP-Server konnte nicht hergestellt werden.';
$GLOBALS['TL_LANG']['tl_nc_gateway']['ftp_error_login']                = 'Login auf FTP-Server fehlgeschlagen.';
...
$GLOBALS['TL_LANG']['tl_nc_gateway']['queue_cronEnable']['0']          = 'Poor-Man-Cron aktivieren';
$GLOBALS['TL_LANG']['tl_nc_gateway']['queue_cronEnable']['1']          = 'Gateway in Poor-Man-Cron registrieren.';
$GLOBALS['TL_LANG']['tl_nc_gateway']['queue_cronInterval']['0']        = 'Intervall';
$GLOBALS['TL_LANG']['tl_nc_gateway']['queue_cronInterval']['1']        = 'Wählen Sie den Intervall für die Aufrufe der Warteschlange des Gateways.';
$GLOBALS['TL_LANG']['tl_nc_gateway']['queue_cronInterval']['daily']    = 'Jeder Tag';
$GLOBALS['TL_LANG']['tl_nc_gateway']['queue_cronInterval']['hourly']   = 'Jede Stunde';
$GLOBALS['TL_LANG']['tl_nc_gateway']['queue_cronInterval']['minutely'] = 'Jede Minute';
$GLOBALS['TL_LANG']['tl_nc_gateway']['queue_cronInterval']['monthly']  = 'Jeder Monat';
$GLOBALS['TL_LANG']['tl_nc_gateway']['queue_cronInterval']['weekly']   = 'Jede Woche';
...
$GLOBALS['TL_LANG']['tl_nc_gateway']['smtpEnc']['1']                   = 'Hier können Sie eine Verschlüsselungsmethode auswählen (SSL oder TLS).';
$GLOBALS['TL_LANG']['tl_nc_gateway']['smtpHost']['0']                  = 'SMTP-Hostname';
$GLOBALS['TL_LANG']['tl_nc_gateway']['smtpHost']['1']                  = 'Bitte geben Sie den Hostnamen des SMTP-Servers ein.';
$GLOBALS['TL_LANG']['tl_nc_gateway']['smtpPass']['0']                  = 'SMTP-Passwort';
$GLOBALS['TL_LANG']['tl_nc_gateway']['smtpPass']['1']                  = 'Hier können Sie das SMTP-Passwort eingeben.';
$GLOBALS['TL_LANG']['tl_nc_gateway']['smtpPort']['0']                  = 'SMTP-Portnummer';
$GLOBALS['TL_LANG']['tl_nc_gateway']['smtpPort']['1']                  = 'Bitte geben Sie die Portnummer des SMTP-Servers ein.';
$GLOBALS['TL_LANG']['tl_nc_gateway']['smtpUser']['0']                  = 'SMTP-Benutzername';
$GLOBALS['TL_LANG']['tl_nc_gateway']['smtpUser']['1']                  = 'Hier können Sie den SMTP-Benutzernamen eingeben.';
...
$GLOBALS['TL_LANG']['tl_nc_gateway']['type']['queue']                  = 'Warteschlange';
$GLOBALS['TL_LANG']['tl_nc_gateway']['useSMTP']['0']                   = ' SMTP-Einstellungen überschreiben';
$GLOBALS['TL_LANG']['tl_nc_gateway']['useSMTP']['1']                   = 'Aktivieren Sie diese Checkbox um die Contao SMTP-Einstellungen (Systemeinstellungen) zu überschreiben und sie anschließend zu individualisieren. ';
